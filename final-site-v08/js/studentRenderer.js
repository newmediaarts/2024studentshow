...
const template = `<div class="container">
                    <div class="row">
                        ...
                        <div class="cols-5 student-hero">
                            <h3 class="name"></h3>
                            <h4 class="program"></h4>
                            <a class="website-link button-alt">Website</a>
                        </div>
...
function createStudentSections(allStudents, studentContainer, studentSection) {
  allStudents.forEach((student, i) => {
    ...
    const studentHero = studentTemplate.querySelector(".student-hero");
    ...
    if (student.program.toLowerCase() === "animation") {
      ...
      demoReelEl.innerHTML = "Demo Reel";
      replaceElementAttributes(demoReelEl, student.demoReelLink);

      studentHero.appendChild(demoReelEl);
    }
